...
```bash
codex plugin marketplace add hjongc/humanizer-kr --ref v0.1.3
...
```bash
CODEX_HOME=/tmp/humanizer-kr-codex-test codex plugin marketplace add hjongc/humanizer-kr --ref v0.1.3
